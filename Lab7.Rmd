...
R2 = .138 and adjusted R2 = .123. Approximately 13.8% of the variance in SWL can be explained by the Big 5 personality traits. After accounting for the number of predictors, the model still explains 12.3% of the variance in SWL. Extraversion, emotional stability and openness can explain unique variance in SWL when controlling for each other, and agreeableness and conscientiousness cannot. 
